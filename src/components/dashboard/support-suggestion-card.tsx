  ...
  return (
    <div className="support-card relative overflow-hidden rounded-2xl border border-border/80 p-5 sm:p-6">
      ...
      <div className="relative">
        ...
        {phase ? (
          <span className="mt-3 inline-flex rounded-full bg-card/90 px-3 py-1 text-xs font-medium text-accent ring-1 ring-border">
        ...
        <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-accent/10 px-4 py-2 text-sm font-medium text-accent-deep ring-1 ring-accent/20">
