...
export function PreferenceStep({
  ...
  const showButton = continueLabel.trim().length > 0;
    ...
    <div className="preference-step animate-fade-in">
      ...
      {showButton ? (
        ...
        <button
          ...
          className="mt-12 w-full rounded-full bg-primary py-4 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition-opacity disabled:opacity-40"
